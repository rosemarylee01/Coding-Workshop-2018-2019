...
public class BigMotor extends Subsystem {
    ...
    double a= 0.8;
	private final SpeedController bigMotor = RobotMap.bigSpeedController;
    ...
    public void bigMotorClock() {
    	bigMotor.set(a);
    	System.err.println("Motor Right");
    }
    
    public void bigMotorCounterClock() {
    	bigMotor.set(-a);
    	System.err.println("Motor Left");
    }
    
    public void bigMotorStop() {
    	bigMotor.set(0.0);
