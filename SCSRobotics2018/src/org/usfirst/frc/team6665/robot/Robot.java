...
public class Robot extends TimedRobot {
    ...
    public static BigMotor bigMotor;
...
//        chooser.addObject("Autonomous Command", new AutonomousCommand());
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS
        SmartDashboard.putData(aCompressor);
        SmartDashboard.putData(bigMotor);
    ...
    public void teleopInit() {
        ...
        drive.start(); 
        System.err.println("teleopInit ran");
    ...
    public void teleopPeriodic() {
        Scheduler.getInstance().run();
        //System.err.println("Hello from teleopPeriodic");
